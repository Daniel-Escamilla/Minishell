...
/*   Updated: 2024/09/11 22:45:36 by user             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "minishell.h"

void	print_cmd_header_and_args(t_cmd *cmd, int *cmd_index)
{
	int	i;
...
void	print_cmd_files(t_cmd *cmd)
{
	int	i;
...
void	print_cmd_order(t_cmd *cmd)
{
	int	i;
